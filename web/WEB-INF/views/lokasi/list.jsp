...
<html>
    ...
    <body>
        <spring:url value="/lokasi/form" var="new_url"/>
            ...
            <c:if test="${ not empty data}">
                <table border="1px" style="border-style: solid" bgcolor="white">
                    <tr bgcolor="pink">
                        ...
                        <c:forEach items="${data}" var="lokasi">
                            <tr>
                                <td>${lokasi.id}</td>
                                <td>${lokasi.nama}</td>
                                <td>${lokasi.keterangan}</td>
                                <td>
                                    <spring:url value="/lokasi/${lokasi.id}" var="delete_url"/>
                                ...
                                <td>
                                    <spring:url value="/lokasi/${lokasi.id}" var="update_url"/>
