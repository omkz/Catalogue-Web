...
<html>
    ...
    <body>
        <spring:url value="/penerbit/form" var="new_url"/>
        <a href="${new_url}">New..</a>

        <fieldset style="border: black solid 1px">
            <legend>Daftar Penerbit</legend>
            <c:if test="${ not empty data}">
                   ...
                   <table border="1px" style="border-style: solid" bgcolor="white">
                    <tr bgcolor="pink">
                        ...
                        <c:forEach items="${data}" var="penerbit">
                            <tr>
                                <td>${penerbit.id}</td>
                                <td>${penerbit.nama}</td>
                                <td>${penerbit.alamat}</td>
                                <td>
                                    <spring:url value="/penerbit/${penerbit.id}" var="delete_url"/>
                                ...
                                <td>
                                    <spring:url value="/penerbit/${penerbit.id}" var="update_url"/>
